...
<div class="navbar glass fixed top-0 shadow-md z-20 bg-base-300 text-neutral">
  ...
  <div class="navbar-end">
    <select name="" id="langSelector" class="select select-bordered text-accent uppercase font-bold" bind:value={currentLocale} on:change={handleLocaleChange} >
